...
const markdownText = `
  ...
  ### This site is [modified to work with Next](https://redux-toolkit.js.org/usage/nextjs) and Redux HMR. Without recommended mods Redux state will reset on every HMR code change.
